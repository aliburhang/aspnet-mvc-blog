    ...
    public class DbSeeder
    {
        ...
        public static void SeedUsers(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(new List<User>
            {
                ...
                new() { Id = 5, Email = "coskun@gmail.com", Password = "coskun", Name = "Onur Eymen Coşkun", City = "İstanbul", Phone = "+905000000000", Definition="My name is Onur Eymen Coşkun, i am from İstanbul",IsActive=true},
                new() { Id = 6, Email = "gunduzoglu@gmail.com", Password = "gunduzoglu", Name = "Cem Gündüzoğlu", City = "İstanbul", Phone = "+905000000000", Definition="My name is Cem Gündüzoğlu, i am from İstanbul",IsActive=true},
                new() { Id = 7, Email = "yilmaz@gmail.com", Password = "yilmaz", Name = "Muhammet Yılmaz", City = "İstanbul", Phone = "+905000000000", Definition="My name is Muhammet Yılmaz, i am from İstanbul",IsActive=true},
            });
        }
